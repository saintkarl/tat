        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header bg-blue">
                    ...
                    <h4 class="modal-title"><fmt:message key="userGroup.management"/> </h4>
                </div>
                <div class="modal-body">
                    <div class="container-fluid">
                        ...
                        <c:url var="formUrl" value="ajax/admin/usergroup/edit.html"/>
                        <form:form commandName="item" id="addUserGroupFormItem" action="${formUrl}" novalidate="novalidate" enctype="multipart/form-data">
                            <div class="tabbable">
                                <ul class="nav nav-tabs" id="myTab">
                                    <li class="active">
                                        <a data-toggle="tab" href="#home">
                                            <i class="green ace-icon fa fa-home bigger-120"></i>
                                            <fmt:message key="fieldset.legend.generalinfo"/>
                                        </a>
                                    </li>
                                    ...
                                    <li>
                                        <a data-toggle="tab" href="#messages">
                                            <i class="green ace-icon fa fa-home bigger-120"></i>
                                            <fmt:message key="fieldset.legend.permission"/>
                                        </a>
                                    </li>
                                </ul>
                                <div class="tab-content">
                                    ...
                                    <div id="messages" class="tab-pane fade">
                                        <display:table name="permissions" cellspacing="0" cellpadding="0" requestURI="#"
                                            ...
                                            <%--<fieldset>--%>
                                                <%--<legend><fmt:message key="fieldset.legend.permission"/></legend>--%>
                                                <%--<div class="form-group" style="padding-left: 15px; padding-right: 15px;">--%>
                                                    <%--<label><fmt:message key="permission.title"/></label>--%>
                                                        <%--<div class="fg-line">--%>
                            ...
                            <fmt:formatDate value='${item.pojo.createdDate}' pattern='dd-MM-yyyy' var="createdDate"/>
                            <input type="hidden" name="pojo.createdDate" value="${createdDate}"/>
                        </form:form>
